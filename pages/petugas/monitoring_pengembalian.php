...
<html lang="en">
  ...
  <body class="flex gap-6 min-h-screen w-full py-8 px-14">
    ...
    <main class="right-dashboard-section">
      ...
      <div class="main-card">
        <!-- Statistics Cards -->
        <div class="dashboard-cards gap-4 mb-6">
          <div class="dashboard-card">
            <div class="card-text">
              <h3>Total Pengembalian</h3>
              <p><?= $total_pengembalian ?></p>
            </div>
            <div class="icon-wrapper icon-blu">
              📊
            </div>
          </div>
          ...
          <div class="dashboard-card">
            ...
            <div class="icon-wrapper icon-ambe">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: inline; margin-right: 8px;"><path d="M12 3a9 9 0 1 0 0 18a9 8 0 0 0 9 -8c0 -4.3 -2 -8 -5 -10"></path><path d="M12 9v6l4 2"></path></svg>
            </div>
          </div>
          ...
          <div class="dashboard-card">
            ...
            <div class="icon-wrapper icon-ros">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: inline; margin-right: 8px;"><path d="M12 9v2m0 4v2"></path><path d="M12 3c-4.97 0 -9 4.03 -9 9s4.03 9 9 9s9 -4.03 9 -9s-4.03 -9 -9 -9"></path></svg>
            </div>
          </div>
          ...
          <div class="dashboard-card">
            ...
            <div class="icon-wrapper icon-indig">
        ...
        <div class="filter-container">
          <a href="?status=all" class="<?= $filter_status === 'all' ? 'filter-tab-pending' : 'filter-tab-inactive' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: inline; margin-right: 8px;"><path d="M9 5H7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2V7a2 2 0 0 0 -2 -2h -2"></path><rect x="9" y="3" width="6" height="4" rx="2"></rect><path d="M9 12h6"></path><path d="M9 16h6"></path></svg> Semua
          </a>
          <a href="?status=terlambat" class="<?= $filter_status === 'terlambat' ? 'filter-tab-late' : 'filter-tab-inactive' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: inline; margin-right: 8px;"><path d="M12 3a9 9 0 1 0 0 18a9 8 0 0 0 9 -8c0 -4.3 -2 -8 -5 -10"></path><path d="M12 9v6l4 2"></path></svg> Terlambat
          </a>
          <a href="?status=rusak" class="<?= $filter_status === 'rusak' ? 'filter-tab-damaged' : 'filter-tab-inactive' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: inline; margin-right: 8px;"><path d="M12 9v2m0 4v2"></path><path d="M12 3c-4.97 0 -9 4.03 -9 9s4.03 9 9 9s9 -4.03 9 -9s-4.03 -9 -9 -9"></path></svg> Rusak
          </a>
        </div>
